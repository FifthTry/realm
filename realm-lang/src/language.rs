...
impl Language {
    ...
    pub fn from_human(s: &str) -> Self {
        match s {
            ...
            "Cree" => Self::Cree,
            "Czech" => Self::Czech,
            "Church Slavonic" => Self::ChurchSlavonic,
