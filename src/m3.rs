...
pub fn handle_sync(
    req: crate::Request,
    f: fn(&crate::Context) -> Result<crate::Response, failure::Error>,
...
pub fn serve(f: fn(&crate::Context) -> Result<crate::Response, failure::Error>) {
...
pub fn handle(f: fn(&crate::Context) -> Result<crate::Response, failure::Error>) {
    serve(f)
}
