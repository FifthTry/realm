...
var author$project$Pages$BasicPage$Model = function (config) {
...
var author$project$Pages$BasicPage$init = function (flag) {
	return _Utils_Tuple2(
		author$project$Pages$BasicPage$Model(flag.config),
...
var author$project$Pages$BasicPage$subscriptions = function (_n0) {
	return elm$core$Platform$Sub$none;
};
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Pages$BasicPage$update = F2(
	function (msg, model) {
...
var author$project$Pages$BasicPage$view2 = function (model) {
	return _List_fromArray(
		[
...
var author$project$Pages$BasicPage$view = function (model) {
	return A2(
		author$project$Realm$wrapped,
		'main',
		author$project$Pages$BasicPage$view2(model));
};
...
var author$project$Pages$BasicPage$main = elm$browser$Browser$element(
	{init: author$project$Pages$BasicPage$init, subscriptions: author$project$Pages$BasicPage$subscriptions, update: author$project$Pages$BasicPage$update, view: author$project$Pages$BasicPage$view});
_Platform_export({'Pages':{'BasicPage':{'init':author$project$Pages$BasicPage$main(
	A2(
