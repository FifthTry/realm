...
var author$project$N$init = function (flag) {
	return _Utils_Tuple2(
		A3(
			author$project$N$Model,
			elm$time$Time$utc,
			...
			elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'uid',
						elm$json$Json$Encode$string('uu')),
						_Utils_Tuple2(
						'id',
						elm$json$Json$Encode$string('ii')),
						_Utils_Tuple2('config', elm$json$Json$Encode$null)
					]))));
};
var author$project$N$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var author$project$N$subscriptions = function (model) {
	return A2(elm$time$Time$every, 1000, author$project$N$Tick);
};
...
var author$project$N$view2 = function (model) {
